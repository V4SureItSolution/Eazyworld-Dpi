...
import { Filter, Eye, RotateCw, LayoutGrid } from 'lucide-react';
import './UserManagement.css';

const PersonalEvaluations = () => {
  ...
  const handleView = () => {
    ...
    setNotification(`Loaded personal interaction evaluation for batch: ${selectedBatch}`);
  ...
  return (
    <div className="user-management-container">
      ...
      <div className="um-header-row">
        <h1 className="um-title">Personal Interaction Evaluation</h1>
        <div className="um-header-right">
          <div className="um-breadcrumb">
            Home / <span>Personal Interaction Evaluation</span>
          </div>
        </div>
      </div>
...
export default PersonalEvaluations;
