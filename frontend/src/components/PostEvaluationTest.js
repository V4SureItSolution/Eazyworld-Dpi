...
const PostEvaluationTest = () => {
  ...
  const handleView = () => {
    ...
    setNotification(`Loaded post-evaluation records for batch: ${selectedBatch}`);
  ...
  return (
    <div className="user-management-container">
      ...
      <div className="um-header-row">
        <h1 className="um-title">Post Evaluation Test</h1>
        <div className="um-header-right">
          <div className="um-breadcrumb">
            Home / <span>Post Evaluation Test</span>
          </div>
        </div>
      </div>
...
export default PostEvaluationTest;
