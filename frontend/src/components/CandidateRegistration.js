...
import { Filter, Eye, RotateCw, Plus, LayoutGrid } from 'lucide-react';
...
const CandidateRegistration = () => {
  ...
  const handleView = () => {
    ...
    setNotification(`Loaded records for batch: ${selectedBatch}`);
  ...
  return (
    <div className="user-management-container">
      ...
      <div className="um-header-row">
        <h1 className="um-title">Candidate Registration</h1>
        <div className="um-header-right">
          <div className="um-breadcrumb">
            Home / <span>Candidate Registration</span>
          </div>
        </div>
      </div>
      ...
      <div className="um-card" style={{ marginBottom: '1.5rem', padding: '1.5rem 1.75rem' }}>
        <div style={{
          ...
          <button 
            ...
            onClick={() => alert('Add New Candidate Registration modal')}
          >
            <Plus size={18} />
            <span>Add New</span>
          </button>
