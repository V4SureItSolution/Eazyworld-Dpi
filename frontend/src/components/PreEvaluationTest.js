...
const PreEvaluationTest = () => {
  ...
  const handleView = () => {
    ...
    setNotification(`Loaded pre-evaluation records for batch: ${selectedBatch}`);
  ...
  return (
    <div className="user-management-container">
      ...
      <div className="um-header-row">
        <h1 className="um-title">Pre Evaluation Test</h1>
        <div className="um-header-right">
          <div className="um-breadcrumb">
            Home / <span>Pre Evaluation Test</span>
          </div>
        </div>
      </div>
